...
type PaymentMethod = "FLUTTERWAVE" | "MANUAL";
          ...
          <div className="rounded-3xl border border-slate-700 bg-slate-900 p-8 shadow-2xl sm:p-10">
            ...
            <div className="text-center">
              ...
              <p className="mt-4 text-slate-400">
                Your manual payment request has been
            ...
            <div className="mt-10 rounded-2xl border border-yellow-500/30 bg-yellow-500/10 p-6">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-300">
                ...
                until an administrator confirms your
                bank transfer. Do not submit another
                payment request for the same transfer.
              </p>
            </div>
            ...
            <div className="mt-6 rounded-2xl border border-cyan-500/20 bg-cyan-500/10 p-5">
              <p className="text-sm leading-6 text-slate-300">
                ...
                will verify the payment before your
                {` ${plan} `}
              ...
              <div className="mt-4 grid gap-4 sm:grid-cols-2">
                ...
                >
                  ...
                  <p className="mt-2 text-sm text-slate-400">
                    Pay online using the available
                ...
                <button
                  ...
                  className={`rounded-2xl border p-5 text-left transition ${
                    paymentMethod === "MANUAL"
                      ? "border-green-400 bg-green-500/10 ring-2 ring-green-500/20"
                      : "border-slate-700 bg-slate-800 hover:border-slate-500"
                  }`}
                >
                  <div className="text-lg font-bold">
                  ...
                  <p className="mt-2 text-sm text-slate-400">
                    Transfer directly to Sonetcom Digital
                    Hub and submit your transfer details.
                  </p>
            ...
            plan !== "FREE" && (
              <div className="mt-8">
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full rounded-2xl bg-gradient-to-r from-cyan-500 to-blue-600 py-4 text-xl font-bold transition hover:scale-[1.02] disabled:cursor-not-allowed disabled:opacity-50"
                >
                  {loading
                    ? "Opening Flutterwave..."
              ...
              <div className="mt-8">
                ...
                <div className="rounded-2xl border border-green-500/20 bg-green-500/5 p-6">
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-400">
                    Transfer exactly the amount shown below
                    to the account and then submit your
                  ...
                  <label className="mt-6 block">
                    ...
                    <textarea
                      ...
                      maxLength={1000}
                      rows={4}
                      placeholder="Enter your bank transfer reference, transaction ID, or any useful payment note..."
                  ...
                  <p className="mt-4 text-center text-xs leading-5 text-slate-500">
                    ...
                    the payment is verified by an administrator.
                  </p>
